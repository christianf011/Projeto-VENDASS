...
df_compras['data'] = pd.to_datetime(df_compras['data']) # Converter a coluna 'data' para datetime
...
data_default = df_compras.index.max().to_pydatetime().date()
...
valor_compras_formatado = f"R$ {valor_compras:.2f}"
col1.metric("Valor de compras no período", valor_compras_formatado)
